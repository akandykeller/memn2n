...
tf.flags.DEFINE_integer("batch_evaluation_interval", 500, "Evaluate and print results every x batches")
tf.flags.DEFINE_integer("batch_evaluation_num_batches", 100, "Evaluate and print results every x batches")
...
with tf.Session() as sess:
    ...
    for t in range(1, FLAGS.epochs+1):
		...
		train_acc = 0.0
		val_acc = 0.0	
		for eval_batch_num in range(0, FLAGS.batch_evaluation_num_batches):
                ...
                print('Total Cost:', cost_t)
                print('Training Accuracy:', train_acc / 10.0)
                print('Validation Accuracy:', val_acc / 10.0)
                print('-----------------------')
