...
tf.flags.DEFINE_integer("epochs", 256, "Number of epochs to train for.")
tf.flags.DEFINE_integer("embedding_size", 80, "Embedding size for embedding matrices.")
tf.flags.DEFINE_integer("memory_size", 70, "Maximum size of memory.")
